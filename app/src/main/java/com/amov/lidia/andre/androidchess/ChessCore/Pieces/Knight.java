...
public class Knight extends GamePiece {
    ...
    public ArrayList<Move> getPossibleMoves() {
        ...
        try{if(this.getGameBoard().getTile(new Point(p.getLine()-2,p.getCol()-1)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()-2,p.getCol()-1),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()-2,p.getCol()+1)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()-2,p.getCol()+1),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()+2,p.getCol()-1)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()+2,p.getCol()-1),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()+2,p.getCol()+1)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()+2,p.getCol()+1),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()-1,p.getCol()-2)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()-1,p.getCol()-2),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()+1,p.getCol()-2)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()+1,p.getCol()-2),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()-1,p.getCol()+2)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()-1,p.getCol()+2),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        try{if(this.getGameBoard().getTile(new Point(p.getLine()+1,p.getCol()+2)).getPieceInTile()==null){ALM.add(new Move(p,new Point(p.getLine()+1,p.getCol()+2),"Knight",this.getLetter(),this.getSide()));}}catch (IndexOutOfBoundsException IOOBex){/*too lazy to add if elses*/}
        return ALM;
